...
@interface ETCollectionViewFlowLayout()
@property(nonatomic,retain)NSMutableDictionary * maxYdic;
@end
@implementation ETCollectionViewFlowLayout
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //计算高度
    CGFloat hight = [self.degelate ETwaterFlow:self heightForWidth:width atIndexPath:indexPath];
